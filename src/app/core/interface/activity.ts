...
export interface IActivity {
    ...
    activity_register_from:string,
    activity_register_to:string,
    activity_skill:string,
...
export interface IActivityFormGroup extends FormGroup{
    ...
    controls:{
        ...
        activity_register_from:AbstractControl,
        activity_register_to:AbstractControl,
        activity_skill:AbstractControl,
