...
export class TicketService {
  ...
  private endpoint = environment.endpoint+'/ticket';
  ...
  genTicket(datas:any): Observable<any>{
    return this.http
    .post(this.endpoint + '/gen', datas, this.httpOptions)
    .pipe(catchError(this.handleError));
  }
  ...
  update(datas: any): Observable<any> {
    return this.http
      .put(this.endpoint + '/' + datas.ticket_id, datas, this.httpOptions)
      .pipe(catchError(this.handleError));
  }
